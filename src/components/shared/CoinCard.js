...
const CoinCard = ({ data }) => {
  ...
  return (
    <div className="flex max-w-screen-2xl flex-col md:flex-row gap-8 md:gap-0 justify-between items-center overflow-hidden text-center   w-10/12 border bg-gray-300 p-2 rounded-lg ">
      ...
      <div className="flex w-full md:w-8/12 justify-around items-center  ">
        ...
        <div className="flex flex-col sm:flex-row justify-around w-6/12 text-center">
